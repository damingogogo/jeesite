 ...
 * @version 2023-03-04
 */
@Table(name="sys_btoupiao_user", alias="a", label="被投票人信息", columns={
		@Column(name="btp_id", attrName="btpId", label="被投票人id", isPK=true),
...
public class BtoupiaoUser extends DataEntity<BtoupiaoUser> {
	
	private static final long serialVersionUID = 1L;
	private String btpId;		// 被投票人id
