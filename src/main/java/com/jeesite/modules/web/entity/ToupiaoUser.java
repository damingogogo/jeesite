 ...
 * @version 2023-03-04
 */
@Table(name="sys_toupiao_user", alias="a", label="投票人信息", columns={
		@Column(name="tp_id", attrName="tpId", label="投票人id", isPK=true),
		@Column(name="toupiao_id", attrName="toupiaoId", label="投票id"),
		@Column(name="btp_id", attrName="btpId", label="被投票id"),
...
public class ToupiaoUser extends DataEntity<ToupiaoUser> {
	
	private static final long serialVersionUID = 1L;
	private String tpId;		// 投票人id
	private String toupiaoId;		// 投票id
	private String btpId;		// 被投票id
	...
	@Size(min=0, max=100, message="被投票id长度不能超过 100 个字符")
	...
	@Size(min=0, max=100, message="用户姓名长度不能超过 100 个字符")
